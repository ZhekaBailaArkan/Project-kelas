function move() {
    var move = document.getElementById('judul');
    var show = document.getElementById('descripsi');
...
function zoomOut2() {
    var zoom = document.getElementById('image-2');
...
function zoomOut3() {
    var zoom3 = document.getElementById('image-3');
    zoom3.style.width = '320px';
    zoom3.style.height = '300px';
...
function zoomIn3() {
    ...
    zoomIn3.style.height = '150px';
    zoomIn3.style.right = '30px';
    zoomIn3.style.boxShadow = 'none'
}

function zoomOut4() {
    var zoom = document.getElementById('image-4');
    zoom.style.width = '320px';
    zoom.style.height = '300px';
    zoom.style.position = 'Absolute';
    zoom.style.right = '450px'
...
function zoomOut5() {
    var zoom = document.getElementById('image-5');
    zoom.style.width = '320px';
    zoom.style.height = '300px';
    zoom.style.position = 'Absolute';
    zoom.style.right = '450px'
...
function zoomOut6() {
    var zoom = document.getElementById('image-7');
    zoom.style.width = '320px';
    zoom.style.height = '300px';
    zoom.style.position = 'Absolute';
    zoom.style.right = '450px'
...
function zoomOut8() {
    var zoom = document.getElementById('image-9');
    zoom.style.width = '320px';
    zoom.style.height = '300px';
    zoom.style.position = 'Absolute';
    zoom.style.right = '450px'
...
function zoomOut9() {
    var zoom = document.getElementById('image-10');
    zoom.style.width = '320px';
    zoom.style.height = '300px';
    zoom.style.position = 'Absolute';
    zoom.style.right = '450px'
